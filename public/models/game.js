...
class Game {
  constructor({p: p, imgs: imgs, matter: matter, ground: ground, worm: worm}) {
    ...
    this.worm = new worm({x: (p.windowWidth/10)*2, y: p.windowHeight - 100, options: "wormOne", img: imgs[0], matter: matter, currentWeapon: imgs[3]});
    this.worm2 = new worm({x: (p.windowWidth/10)*8, y: p.windowHeight - 100, options: "wormTwo", img: imgs[1], matter: matter, currentWeapon: imgs[2]});
