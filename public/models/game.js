...
class Game {
  constructor({p: p, imgs: imgs, matter: matter, ground: ground, worm: worm}) {
    ...
    this.worm = new worm({x: (p.windowWidth/10)*2, y: p.windowHeight - 100, options: "wormOne", imgs: imgs[0], matter: matter});
    this.worm2 = new worm({x: (p.windowWidth/10)*8, y: p.windowHeight - 100, options: "wormTwo", imgs: imgs[1], matter: matter});
